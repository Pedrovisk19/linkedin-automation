"""Use cases do telegram: receber mensagem e processar aprovacao."""
...
class HandleInboundMessage:
    ...
    4. Cria um TelegramRequest pendente e envia os botoes de aprovacao.
    """
    ...
    def __init__(
        ...
        *,
        ...
        requests: TelegramRequestRepository,
    ...
    async def execute(
        ...
        *,
        ...
        await self._messenger.send_approval_request(
            ...
            body=_truncate(draft.texto, 1000),
        )
        return request

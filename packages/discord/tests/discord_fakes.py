"""Fakes para discord tests (sem DB, sem gateway e sem HTTP)."""
...
class FakeDiscordRequestRepository:
    def __init__(self) -> None:
        self._by_id: dict[str, DiscordRequest] = {}
    ...
    async def get_pending_by_channel(
        ...
        for r in self._by_id.values():
            if r.tenant_id == tenant_id and r.channel_id.value == channel_id:
                return r
        return None

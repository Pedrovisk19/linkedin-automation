"""Testes dos use cases do discord com fakes."""
    ...
    with pytest.raises(ValidationError) as exc:
        asyncio.run(
            uc.execute(
                ...
                channel_id=CHANNEL,
                text=None,
                audio_media_id="https://cdn.discordapp.com/attachments/x/a.ogg",
            )
        )
